...
import CardIcon from '../../assets/logo.png'
import './index.css'

export default function index({element}) {
    return (
        <div className="cards-main">
            <center><img src={CardIcon} width={100} height={100} style={{ borderRadius: '50px' }} /></center><br />
            <div className="cards-inner-main">
